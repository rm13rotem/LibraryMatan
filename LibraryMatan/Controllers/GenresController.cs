...
namespace LibraryMatan.Controllers
{
    public class GenresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,GenreName,CreatedDateTime")] Genre genre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,GenreName,CreatedDateTime")] Genre genre)
        {
            if (id != genre.Id)
            {
                return NotFound();
